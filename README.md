...
* [kivy](https://kivy.org/#home)-A cross platform user interface toolkit
* [PyQt](http://pyqt.sourceforge.net/Docs/PyQt5)-A crossplatform GUI toolkit to build desktop applications
